        ...
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              ...
              window.setTimeout(function () {
                location.assign("/product-page/".concat(slug));
              }, 1500);
            }
...
var patchResetPassword = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(password, passwordConfirm) {
    var resetResult;
  ...
  return function patchResetPassword(_x19, _x20) {
...
if (logoutBtn) logoutBtn.addEventListener('click', _utils.logout); //Signup
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _utils.signup)(name, email, password, confirmPassword);
  });
}
...
if (contactPageForm) {
  contactPageForm.addEventListener('submit', function (e) {
    ...
    var message = document.getElementById('message').value; //console.log(message);

    var subject = document.getElementById('subject').value; //console.log(subject);

    (0, _utils.postComment)(name, email, message, subject);
  });
}
...
if (reviewPageForm) {
  reviewPageForm.addEventListener('submit', function (e) {
    e.preventDefault(); //VALUES
    //get the details

    var review = document.getElementById('reviewDetails').value; //console.log(review);

    var rating = document.getElementById('rating').value; //console.log(rating);

    var userId = document.getElementById('userId').value; //console.log(userId);

    var productId = document.getElementById('productId').value; //console.log(productId);
...
if (resetPasswordPageForm) {
  resetPasswordPageForm.addEventListener('submit', function (e) {
    e.preventDefault(); //VALUES
    //get the details
