...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"login-logout.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              alert("Login omo aiye"); //showAlert('success', 'Logged in Successfully');
...
//DOM ELEMENT
var loginForm = document.querySelector('.contact_form');
var logoutBtn = document.querySelector('.nav-link.logout'); //Login
