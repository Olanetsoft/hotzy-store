...
},{}],"login-logout.js":[function(require,module,exports) {
"use strict";
...
var signupForm = document.querySelector('.contact_form.signup'); //Login
...
if (logoutBtn) logoutBtn.addEventListener('click', _loginLogout.logout); //Signup
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _loginLogout.signup)(name, email, password, confirmPassword);
  });
}
