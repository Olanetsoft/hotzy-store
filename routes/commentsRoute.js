...
router.post('/api/v1/comment-message',authController.protectRouteToEnableOnlyLoggedInUser, authController.restrictAccessTo('user'), commentController.postComment);
